...
import { truncateCells } from '../../workstation/chrome/text'
import {
    LogInkSidebarTab,
    LogInkState,
    LogInkView,
...
// Per-surface renderers extracted in phases 5a.1-5a.6 (#890). All 12 main
// surfaces (+ conflicts + the detail family) now live in their own modules.
// The chrome render helpers (header, sidebar, footer, overlays, palette)
// will follow in phase 5a.7.
...
} from '../../workstation/surfaces/detail'
