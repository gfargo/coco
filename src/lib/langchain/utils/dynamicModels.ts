...
const OPENAI_DYNAMIC_DEFAULTS: ProviderDynamicDefaults = {
  ...
  cost: {
    ...
    review: 'gpt-5.4-mini',
    blameExplain: 'gpt-5.4-mini',
    conflictResolve: 'gpt-5.4-mini',
    recap: 'gpt-5.4-nano',
    repair: 'gpt-5.4-mini',
    largeDiff: 'gpt-5.4',
  },
  balanced: {
    ...
    changelog: 'gpt-5.4',
    review: 'gpt-5.4',
    blameExplain: 'gpt-5.4',
    conflictResolve: 'gpt-5.4',
    recap: 'gpt-5.4-mini',
    repair: 'gpt-5.4',
    largeDiff: 'gpt-5.4',
  },
  quality: {
    ...
    changelog: 'gpt-5.5',
    review: 'gpt-5.5',
    blameExplain: 'gpt-5.5',
    conflictResolve: 'gpt-5.5',
    recap: 'gpt-5.5',
    repair: 'gpt-5.5',
    largeDiff: 'gpt-5.5',
  },
...
const ANTHROPIC_DYNAMIC_DEFAULTS: ProviderDynamicDefaults = {
  ...
  cost: {
    ...
    blameExplain: 'claude-sonnet-4-6',
    conflictResolve: 'claude-sonnet-4-6',
  ...
  balanced: {
    ...
    blameExplain: 'claude-opus-4-6',
    conflictResolve: 'claude-opus-4-6',
  ...
  quality: {
    ...
    blameExplain: 'claude-opus-4-8',
    conflictResolve: 'claude-opus-4-8',
...
const GEMINI_DYNAMIC_DEFAULTS: ProviderDynamicDefaults = {
  cost: {
    ...
    blameExplain: 'gemini-2.5-flash',
    conflictResolve: 'gemini-2.5-flash',
  ...
  balanced: {
    ...
    blameExplain: 'gemini-2.5-pro',
    conflictResolve: 'gemini-2.5-pro',
...
const MISTRAL_DYNAMIC_DEFAULTS: ProviderDynamicDefaults = {
  cost: {
    ...
    blameExplain: 'mistral-small-latest',
    conflictResolve: 'mistral-small-latest',
  ...
  balanced: {
    ...
    blameExplain: 'mistral-medium-latest',
    conflictResolve: 'mistral-medium-latest',
  ...
  quality: {
    ...
    blameExplain: 'mistral-large-latest',
    conflictResolve: 'mistral-large-latest',
...
const BEDROCK_DYNAMIC_DEFAULTS: ProviderDynamicDefaults = {
  ...
  cost: {
    ...
    blameExplain: 'anthropic.claude-sonnet-4-6',
    conflictResolve: 'anthropic.claude-sonnet-4-6',
  ...
  balanced: {
    ...
    blameExplain: 'anthropic.claude-opus-4-7',
    conflictResolve: 'anthropic.claude-opus-4-7',
  ...
  quality: {
    ...
    blameExplain: 'anthropic.claude-opus-4-8',
    conflictResolve: 'anthropic.claude-opus-4-8',
...
const OLLAMA_DYNAMIC_DEFAULTS: ProviderDynamicDefaults = {
  cost: {
    ...
    blameExplain: 'qwen2.5-coder:7b',
    conflictResolve: 'qwen2.5-coder:7b',
    recap: 'llama3.2:3b',
  ...
  balanced: {
    ...
    blameExplain: 'qwen2.5-coder:32b',
    conflictResolve: 'qwen2.5-coder:32b',
    recap: 'llama3.1:8b',
